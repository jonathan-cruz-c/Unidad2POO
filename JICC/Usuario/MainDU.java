...
class MainDU {
    ...
    public static void main(String[] args) {
        ...
        // Creación de un objeto DivisionU
        DivisionU us1 = new DivisionU();
        ...
        do {
            ...
            System.out.println("1.- Hacer la división");
            ...
            switch (opc) {
                ...
                case 1:
                    ...
                    // Calcula el resultado de la división y se guarda en la variable r
                    double r = us1.getNum1() / us1.getNum2();
